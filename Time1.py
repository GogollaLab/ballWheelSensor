...
#endTime = input("How long is the imaging session (answer in seconds; time from TTL HIGH to end of the aqusition)?")
endTime = input()
...
#dev = usb.core.find(idVendor=0x046d, idProduct=0xc077) #Logitech B100 mouse
# first endpoint
interface = 0
